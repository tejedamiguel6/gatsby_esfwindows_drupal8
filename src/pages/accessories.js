...
const Accessories = () => {
  ...
  accessoriesBasicPage: nodePage(id: { eq: "5777f841-acbe-572d-b820-7d2b4f6caf48" }) {
    title
    body {
      value
    }
    ...
    const accessoriesImage = data.accessoriesBasicPage.relationships.field_basic_page_image[0].localFile.childImageSharp.fluid
            ...
            <Layout>
                ...
                <FlexContainer>
                    {data.allNodeAccessories.edges.map((edge) => {
                        const images = edge.node.relationships.field_accessories_image[0].localFile.childImageSharp.fluid
                        return (
